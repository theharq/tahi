ETahi.RyanOverlayController = ETahi.TaskController.extend({
  ...
  translateText: function(){
    $.getScript("//translate.google.com/translate_a/element.js?hl=&tl=en&cb=googleTranslateElementInit");
    $("#paper-goes-here").html(this.get("paperText"));
  },
